        ...
        return (
            <div>
                    ...
                    <picture>
                        ...
                        <img src={data.sidebar.image.png} alt="" className="filter drop-shadow-lg  rounded-md w-min-1/3"></img>
                        </picture>
                    <h1 className="text-2xl text-grayAccent font-bold uppercase mt-3"> {data.sidebar.name} </h1>
                ...
                <a href="./cv.pdf" target="_blank" rel="noreferrer">
                    <div className="bg-white rounded-md mt-7 m-3 p-3 group shadow-lg text-center text-secondAccent underline font-medium hover:bg-grayAccent ">
                        <i className="fas fa-file-pdf text-mainAccent group-hover:text-secondAccent transition-colors mr-3"></i>View my CV
                </div>
                </a>
